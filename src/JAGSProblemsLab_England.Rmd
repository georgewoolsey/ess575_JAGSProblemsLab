...
\textcolor{violet}{The ${\sf Bernoulli}$ distribution is the discrete probability distribution of a random variable which takes the value 1 with probability $p$ and the value 0 with probability $q=1-p$ and a variance $\sigma^2 = pq = p(1-p)$. The model above includes $p$ which can be utilized to determine the variance $\sigma^2$.}
